...
public class Route {
    ...
    public static String GestionUsuario = "/FXML/gestion_usuario.fxml";
    public static String GestionUsuarioCambio = "/FXML/gestion_usuario_recuperar.fxml";
    public static String GestionUsuarioClave = "/FXML/gestion_usuario_cambio_clave.fxml";
    public static String GestionUsuarioParent = "/FXML/gestion_usuario_parent.fxml";
    ...
    public static String ScreenEstructura = "/FXML/screen_edit_estructura.fxml";
    public static String ScreenShowEstructura = "/FXML/screen_show_estructura.fxml";
    ...
    public static String ScreenMainHome = "/FXML/screen_main_home.fxml";
    ...
    public static String ScreenHomeBackground = "/FXML/screen_home_background.fxml";
